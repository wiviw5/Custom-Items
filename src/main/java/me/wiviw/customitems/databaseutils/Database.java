...
public abstract class Database {
    ...
    // TODO Remove all instances of all of this below, we will be creating tables/accessing tables via "DB:".
    public String table = "buffer_names";
    public int tokens = 0;
    public Database(CustomItems instance){
        plugin = instance;
    }

    public abstract Connection getSQLConnection(String DBName);

    public abstract void load(String DBName);
    ...
    /*
    // TODO Future Implementations for methods will go in another class possibly. Will ask on this whether or not its right to be put here or not.
